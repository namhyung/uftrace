...
void qsort_r(void *base, size_t nmemb, size_t size, funcptr_t compar,
	     void *arg);
...
void *mmap(void *addr, size_t length, enum uft_mmap_prot prot,
	   enum uft_mmap_flag flags, int fd, off_t offset);
void *mmap64(void *addr, size_t length, enum uft_mmap_prot prot,
	     enum uft_mmap_flag flags, int fd, off64_t offset);
...
int pthread_create(pthread_t *thread, const pthread_attr_t *attr,
		   funcptr_t start_routine, void *arg);
...
const char *inet_ntop(enum uft_socket_domain af, const void *src, char *dst,
		      socklen_t size);
...
int sigaction(enum uft_signal signum, const struct sigaction *act,
...
int pthread_sigmask(enum uft_sigmask how, const sigset_t *set,
		    sigset_t *oldset);
////////////////////////////////////////////////////////////////////////////////
...
int pselect(int nfds, void *rset, void *wset, void *eset, void *timeout,
	    sigset_t *mask);
...
int epoll_pwait(int efd, void *events, int max_event, int timeout,
		sigset_t *mask);
