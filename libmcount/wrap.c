...
static void send_dlopen_msg(struct mcount_thread_data *mtdp,
			    const char *sess_id, uint64_t timestamp,
...
static int dlopen_base_callback(struct dl_phdr_info *info, size_t size,
				void *arg)
{
