...
static void init_symtab(void)
{
	...
	uftrace_shmem_fd = uftrace_shmem_open(uftrace_shmem_name, O_RDWR | O_CREAT | O_TRUNC, 0700);
...
static void init_dbginfo(void)
{
	...
	uftrace_shmem_dbg_fd =
		uftrace_shmem_open(uftrace_shmem_dbg_name, O_RDWR | O_CREAT | O_TRUNC, 0700);
